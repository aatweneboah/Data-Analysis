...
setwd('//wsl.localhost/Ubuntu/home/aatweneboah/data_analysis/Data-Analysis')
getwd()
getwd()
...
colMeans(data_set)
data_set[,1:4]
data_set[,c("Sepal.Length","Sepal.Width","Petal.Length","Petal.Width")]

#store data set in variable
data_set1 <- data_set[,c("Sepal.Length","Sepal.Width","Petal.Length","Petal.Width")]
